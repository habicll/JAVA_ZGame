...
/**
 * The {@code BaseZombieDestroyedOverlay} class displays an overlay when the zombie base is destroyed.
 * It renders a semi-transparent background, a "YOU WIN" title, and interactive buttons (REPLAY, QUIT).
...
public class BaseZombieDestroyedOverlay implements Disposable {
    ...
    /**
     * Renders the destroyed zombie base overlay, including background, title, and buttons.
